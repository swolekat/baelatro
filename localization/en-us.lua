return {
    descriptions={
        ...
        Joker={
            ...
            j_to_the_moon={
                name="Bang! Zoom! Goon To the Moon",
                text={
    ...
    misc={
        ...
        dictionary={
            ...
            k_drank_ex="Drank!",
            k_duplicated_ex="Another One!",
            k_dwarf_planet="Best Planet",
            k_eaten_ex="Nommed!",
            k_edition="Edition",
